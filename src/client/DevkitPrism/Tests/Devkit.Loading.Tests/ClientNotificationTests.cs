...
public sealed class ClientNotificationTests
{
    ...
    [Fact]
    public async Task Webapp_missing_source_configuration_reports_warning()
    {
        ...
        var viewModel = new WebappUpdateViewModel(
            new Barcode2TestConfigurationService(),
            notifications.Object)
        {
            WebappPath = string.Empty
        };

        await viewModel.UpdateFilesCommand.ExecuteAsync("test");
